...
#define Py_UNICODE_IStitre(ch) _PyUnicode_Istitrecase(ch)
#define Py_UNICODE_ISLINEBREAK(ch) _PyUnicode_IsLinebreak(ch)

#define Py_UNICODE_TOLOWER(ch) _PyUnicode_ToLowercase(ch)
#define Py_UNICODE_TOUPPER(ch) _PyUnicode_ToUppercase(ch)
#define Py_UNICODE_TOtitre(ch) _PyUnicode_Totitrecase(ch)
...
PyAPI_FUNC(int) _PyUnicode_Istitrecase(
    Py_UCS4 ch       /* Unicode character */
    );
...
Py_DEPRECATED(3.3) PyAPI_FUNC(Py_UCS4) _PyUnicode_Totitrecase(
    Py_UCS4 ch       /* Unicode character */
    );
...
PyAPI_FUNC(int) _PyUnicode_TotitreFull(
    Py_UCS4 ch,       /* Unicode character */
    Py_UCS4 *res
    );
