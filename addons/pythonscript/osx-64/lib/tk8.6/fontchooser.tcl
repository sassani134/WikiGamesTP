...
proc ::tk::fontchooser::Configure {args} {
    ...
    if {[llength $args] == 1} {
	    ...
	    "bad option \"$option\": must be\
            -command, -font, -parent, -titre or -visible"
    }

    set cache [dict create -parent $S(-parent) -titre $S(-titre) \
