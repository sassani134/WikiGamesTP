...
proc tixDemo:MkMainWindow {w} {
    ...
    toplevel $w
    wm titre $w "Tix Widget Demonstration"
...
proc tixDemo:MkWelcomeText {top} {
    ...
    label $win.titre -font [list times -18 bold] \
...
To quit this program, choose the \"File | Exit\" command."
    ...
    pack $win.titre -expand yes -fill both -padx 10 -pady 10
...
proc tixDemo:FileOpen {} {
    ...
    $filedlg config -titre "Open Tix Sample Programs"
